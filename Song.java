...
/**
 * The <code>Song</code> class represents a song. Each song has a title, artist, play time, and file
 * path.
 *
...
public class Song
{
	 ...
	 * 
	 * @param playtime this song's playtime
	 */
	 ...
	 * 
	 * @param filePath this song's filePath
	 */
	...
	/*
	 * Returns a formatted list of the song.
	 * 
	...
	{
		return String.format("%-20s %-20s %-25s %20d\n", title, artist, filePath, playTime);
	}
}
